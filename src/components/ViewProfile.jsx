...
const ViewProfile = () => {
  ...
  const fetchProfileData = async () => {
    ...
    if (parsedProfile) {
      ...
      setProfileData(prevState => ({
        ...
        licenseLocation: parsedProfile.licenseLocation || prevState.licenseLocation,
        about: parsedProfile.about || prevState.about,
        qualifications: parsedProfile.qualifications || prevState.qualifications
      }));
    }
  };
  ...
  const handleImageUpload = async (e) => {
    ...
    try {
      const response = await axios.post(`${baseUrl}/api/v1/doctor-profile/upload-credentials`, formData, {
        headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const submitData = {
        ...profileData,
        qualifications: profileData.qualifications.map(q => q.value).join(', '),
    ...
    <div className="max-w-4xl mx-auto p-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">License Location</label>
            <input
              type="text"
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700">Tell patients about yourself</label>
          <textarea
            name="about"
