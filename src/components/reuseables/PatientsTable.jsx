...
const PatientTable = ({ data = [], isLoading = false, emptyMessage }) => {
  return (
    <div className="w-full border rounded-lg flex flex-col h-[600px]">
            ...
            {isLoading ? (
              ...
              data.map((patient, index) => (
                <tr key={index} className="border-b border-gray-200 hover:bg-gray-50">
                  <td className="px-4 py-4 whitespace-nowrap font-medium text-gray-900">{patient.firstName}</td>
                  <td className="px-4 py-4 whitespace-nowrap text-gray-700">{patient.lastName}</td>
                  <td className="px-4 py-4 whitespace-nowrap text-gray-700">{patient.visitDate}</td>
                  ...
                  <td className="px-4 py-4 text-gray-700">{patient.drugs}</td>
