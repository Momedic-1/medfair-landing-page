...
//       axios.get(`${baseUrl}/api/call/${id}/total-patients-consultation`, {
//         headers: {
...
//             returnPatient: data.returnPatient || 0,
//             totalPatient: data.consultations || 0,
//           }));
//         })
//         .catch(error => {
//           console.error('Error fetching consultation and patient data:', error);
...
//       axios.get(`${baseUrl}/api/call/missed/count?doctorId=${id}`, {
//         headers: {
//           Authorization: `Bearer ${token}`,
//         },
//       })
  ...
  useEffect(() => {
    const fetchMissedCallsAndMessages = async () => {
      if (userData && token) {
        ...
        try {
          // Fetch missed calls and messages
          const response = await axios.get(
